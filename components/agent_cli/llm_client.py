...
class LLMClient:
    ...
    def _setup_gemini(self):
        ...
        self.model = genai.GenerativeModel(
            ...
            system_instruction=(
                "You are a Kubernetes operations agent for the citrus namespace. "
                "Always use the available tools to gather live data before answering. "
                "Do not ask the user clarifying questions about namespace; tools already "
                "target citrus. Prefer calling tools over refusing."
            ),
        )
